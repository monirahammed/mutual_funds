...
--
-- Table structure for table `funds_name_info`
--

DROP TABLE IF EXISTS `funds_name_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `funds_name_info` (
  `recordId` int(11) NOT NULL AUTO_INCREMENT,
  `mfFundName` varchar(100) DEFAULT NULL,
  `mfFundHouse` varchar(80) DEFAULT NULL,
  `mfCode` varchar(10) DEFAULT NULL,
  `fundType` varchar(50) DEFAULT NULL,
  `snapshotDate` date DEFAULT NULL,
  `createDate` date DEFAULT NULL,
  PRIMARY KEY (`recordId`)
) ENGINE=InnoDB AUTO_INCREMENT=157969 DEFAULT CHARSET=latin1;
